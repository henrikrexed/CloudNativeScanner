...
-- Insert additional default search topics for StackOverflow (user-requested topics)
INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'gateway api', 'gateway api', 'Gateway API questions and discussions', 1, 50
FROM sources s WHERE s.name = 'StackOverflow';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'opentelemetry', 'opentelemetry', 'OpenTelemetry observability questions', 1, 50
FROM sources s WHERE s.name = 'StackOverflow';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'logs', 'kubernetes logs', 'Kubernetes logging questions', 1, 50
FROM sources s WHERE s.name = 'StackOverflow';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'metrics', 'kubernetes metrics', 'Kubernetes metrics and monitoring questions', 1, 50
FROM sources s WHERE s.name = 'StackOverflow';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'traces', 'kubernetes traces', 'Distributed tracing in Kubernetes questions', 1, 50
FROM sources s WHERE s.name = 'StackOverflow';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'kubernetes networking', 'kubernetes networking', 'Kubernetes networking questions', 1, 50
FROM sources s WHERE s.name = 'StackOverflow';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'kubernetes security', 'kubernetes security', 'Kubernetes security questions', 1, 50
FROM sources s WHERE s.name = 'StackOverflow';

-- Insert additional default search topics for Reddit (user-requested topics)
INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'gateway api', 'gateway api', 'Gateway API community discussions', 1, 25
FROM sources s WHERE s.name = 'Reddit';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'opentelemetry', 'opentelemetry', 'OpenTelemetry community discussions', 1, 25
FROM sources s WHERE s.name = 'Reddit';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'logs', 'kubernetes logs', 'Kubernetes logging discussions', 1, 25
FROM sources s WHERE s.name = 'Reddit';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'metrics', 'kubernetes metrics', 'Kubernetes metrics discussions', 1, 25
FROM sources s WHERE s.name = 'Reddit';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'traces', 'kubernetes traces', 'Distributed tracing discussions', 1, 25
FROM sources s WHERE s.name = 'Reddit';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'kubernetes networking', 'kubernetes networking', 'Kubernetes networking discussions', 1, 25
FROM sources s WHERE s.name = 'Reddit';

INSERT INTO search_topics (source_id, keyword, search_query, description, priority, max_results) 
SELECT s.id, 'kubernetes security', 'kubernetes security', 'Kubernetes security discussions', 1, 25
FROM sources s WHERE s.name = 'Reddit';
